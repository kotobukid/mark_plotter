  ...
  g.rect_edit_layer(
    ...
    transformed-event-emitter(
      ...
      g(v-if="show_preview && plotting")
        rect.preview(:x="rect_preview.x" :y="rect_preview.y" :width="rect_preview.width" :height="rect_preview.height" fill="transparent" stroke="black" stroke-width="1")
